# Project 3 - *Parstigram*

**Parstigram** is a photo sharing app similar to Instagram but using Parse as its backend.
...
- Indeterminate progress bar does work, but with good internet, it doesn't have a chance to show up on screen.
